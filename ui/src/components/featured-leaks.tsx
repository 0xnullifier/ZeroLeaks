  ...
  const featuredLeaks = [
    {
      ...
      date: "2023-11-15",
      summary: "Internal documents revealing systematic environmental regulation violations by a major corporation.",
    ...
    },
    {
      ...
      category: "Government",
      date: "2023-10-22",
      summary: "Classified documents detailing an undisclosed mass surveillance program targeting civilians.",
    ...
    },
    {
      ...
      category: "Finance",
      date: "2023-09-30",
      summary: "Evidence of systematic fraud and market manipulation by major financial institutions.",
      tags: ["finance", "fraud"],
      views: 9821,
    },
  ]
        ...
        >
          <CardHeader className="pb-2">
            <div className="flex justify-between items-start">
              <Badge className="mb-2 bg-primary/90 hover:bg-primary">{leak.category}</Badge>
            ...
            <CardTitle className="text-xl">
              <Link to={`/leaks/${leak.id}`} className="hover:text-primary/80 transition-colors">
                {leak.title}
              </Link>
            </CardTitle>
          </CardHeader>
