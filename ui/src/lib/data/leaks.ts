...
export const LEAKS: Leak[] = [
  {
    ...
    fromLeakedEmail: "security.insider@protonmail.com",
    verifiedClaim: "Breach confirmed by internal forensics and legal memos.",
    relatedDocuments: [
    ...
    verificationDigest: "0x123456789abcdef123456789abcdef123456789abcdef123456789abcdef1234"
  },
  {
    id: "leak-002",
    ...
    fromLeakedEmail: "clinical.researcher@securemail.org",
    verifiedClaim: "Suppressed trial data confirmed by raw data and internal memos.",
    relatedDocuments: [
  ...
  },
  {
    ...
    fromLeakedEmail: "concerned.agent@tutanota.com",
    verifiedClaim: "Surveillance program confirmed by classified documents.",
    relatedDocuments: [
  ...
  },
  {
    ...
    fromLeakedEmail: "banking.insider@guerrillamail.com",
    verifiedClaim: "Predatory lending confirmed by training and revenue documents.",
    relatedDocuments: [
  ...
  },
  {
    ...
    fromLeakedEmail: "military.engineer@protonmail.com",
    verifiedClaim: "Defective equipment confirmed by test failures and cover-up emails.",
    relatedDocuments: [
